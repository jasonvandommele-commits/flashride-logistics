...
export default function TourneesRegulieres() {
  return (
    <main className="bg-white text-gray-900 min-h-screen">
      ...
      <section className="relative pt-24 min-h-[560px] flex items-center bg-gradient-to-br from-black via-[#0B1F3A] to-black text-white">
      ...
      <section className="py-16 px-6 bg-[#0B1F3A] text-white">
        ...
        items={[
          {
            ...
            answer:
              "Quotidienne, hebdomadaire ou selon un planning personnalisé défini avec vous en fonction de votre activité."
          },
          {
            question: "Puis-je modifier ma tournée en cours de contrat ?",
            answer:
              "Oui, nos solutions sont flexibles et s'adaptent à l'évolution de vos besoins."
          },
          {
            question: "Y a-t-il un engagement minimum ?",
            answer:
              "Nous étudions chaque demande individuellement pour proposer une organisation adaptée, sans contrainte excessive."
          }
        ]}
      />
