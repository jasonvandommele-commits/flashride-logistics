...
export default function TransportExpress() {
  return (
    <main className="bg-white text-gray-900 min-h-screen">
      ...
      {/* BANNIÈRE HERO */}
      <section
        className="relative pt-24 min-h-[540px] flex items-center bg-cover bg-center"
        style={{
          backgroundImage:
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 text-white">
          ...
          <p className="text-orange-400 font-bold uppercase tracking-[0.2em] mb-4">
            TRANSPORT EXPRESS
          </p>

          <h1 className="text-4xl md:text-5xl font-black leading-tight max-w-4xl">
            Transport express :
          ...
          <p className="mt-6 text-gray-200 text-lg md:text-xl leading-relaxed max-w-3xl">
      ...
      <section className="py-16 px-6 bg-white">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-[#0B1F3A] text-white rounded-2xl p-7">
      ...
      <section className="py-16 px-6 bg-[#0B1F3A] text-white text-center">
        ...
        <a
          href="tel:0752988155"
          className="inline-block mt-7 bg-orange-500 px-7 py-3.5 rounded-xl font-bold text-base hover:bg-orange-600 transition"
        >
        ...
        items={[
          {
            ...
            answer:
              "Selon votre localisation en Île-de-France, nous pouvons généralement intervenir sous 1 à 2 heures après confirmation de la demande."
          },
          {
            question: "Le transport express est-il disponible le week-end ?",
            answer:
              "Oui, nous sommes disponibles 7j/7 et 24h/24 pour vos besoins de transport urgents."
          },
          {
            question: "Quels types de colis ou marchandises acceptez-vous ?",
            answer:
              "Documents, plis, colis jusqu'aux volumes plus importants selon le véhicule mobilisé. Précisez votre besoin lors de la demande de devis."
          }
        ]}
      />
